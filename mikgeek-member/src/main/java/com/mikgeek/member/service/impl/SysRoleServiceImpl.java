...
import com.mikgeek.member.domain.SysRoleDept;
import com.mikgeek.member.domain.SysRoleMenu;
import com.mikgeek.member.domain.SysUserRole;
import com.mikgeek.member.mapper.SysRoleMenuMapper;
import com.mikgeek.member.api.domain.SysRole;
import com.mikgeek.member.api.model.LoginUser;
import com.mikgeek.member.mapper.SysRoleDeptMapper;
import com.mikgeek.member.mapper.SysRoleMapper;
import com.mikgeek.member.mapper.SysUserRoleMapper;
import com.mikgeek.member.service.ISysRoleService;
...
public class SysRoleServiceImpl implements ISysRoleService {
    ...
    private Wrapper<SysRole> buildQueryWrapper(SysRole role) {
        ...
        wrapper.eq("r.del_flag", UserConstants.ROLE_NORMAL)
            .eq(ObjectUtil.isNotNull(role.getId()), "r.role_id", role.getId())
            .like(StringUtils.isNotBlank(role.getName()), "r.role_name", role.getName())
            ...
            .orderByAsc("r.sort").orderByAsc("r.create_time");
        ;
        return wrapper;
    }
    ...
    public int updateRoleStatus(SysRole role) {
        if (UserConstants.ROLE_DISABLE.equals(role.getStatus()) && this.countUserRoleByRoleId(role.getId()) > 0) {
